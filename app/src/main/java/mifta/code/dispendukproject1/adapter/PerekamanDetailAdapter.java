...
public class PerekamanDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context context;
    private final List<tampil> results;

    public PerekamanDetailAdapter(Context context, List<tampil> results) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        PerekamanDetailAdapter.MyHolder holder = new PerekamanDetailAdapter.MyHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        PerekamanDetailAdapter.MyHolder myHolder = (PerekamanDetailAdapter.MyHolder) holder;
