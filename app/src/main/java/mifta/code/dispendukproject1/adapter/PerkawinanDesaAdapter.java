...
public class PerkawinanDesaAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context context;
    private final List<tampil> results;

    public PerkawinanDesaAdapter(Context context, List<tampil> results) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        PerkawinanDesaAdapter.MyHolder holder = new PerkawinanDesaAdapter.MyHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        PerkawinanDesaAdapter.MyHolder myHolder = (PerkawinanDesaAdapter.MyHolder) holder;
        ...
        myHolder.jenis.setText("Akta Perkawinan");
        Glide.with(myHolder.itemView.getContext())
                .load(R.drawable.ic_perkawinan)
