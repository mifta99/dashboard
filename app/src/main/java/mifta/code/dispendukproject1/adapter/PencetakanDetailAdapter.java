...
public class PencetakanDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context context;
    private final List<tampil> results;

    public PencetakanDetailAdapter(Context context, List<tampil> results) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        PencetakanDetailAdapter.MyHolder holder = new PencetakanDetailAdapter.MyHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        PencetakanDetailAdapter.MyHolder myHolder = (PencetakanDetailAdapter.MyHolder) holder;
