...
import mifta.code.dispendukproject1.activity.KematianDetailActivity;
import mifta.code.dispendukproject1.api.tampil;

public class KematianDesaAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context context;
    private final List<tampil> results;

    public KematianDesaAdapter(Context context, List<tampil> results) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        KematianDesaAdapter.MyHolder holder = new KematianDesaAdapter.MyHolder(v);
        return holder;
    }
