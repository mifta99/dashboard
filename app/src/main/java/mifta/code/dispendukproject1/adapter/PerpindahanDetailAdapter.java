...
public class PerpindahanDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context context;
    private final List<tampil> results;

    public PerpindahanDetailAdapter(Context context, List<tampil> results) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        PerpindahanDetailAdapter.MyHolder holder = new PerpindahanDetailAdapter.MyHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        PerpindahanDetailAdapter.MyHolder myHolder = (PerpindahanDetailAdapter.MyHolder) holder;
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        TextView user, nik, no_kk, nama, tgl, alamat, no_doc;
        LinearLayout ly_doc;
