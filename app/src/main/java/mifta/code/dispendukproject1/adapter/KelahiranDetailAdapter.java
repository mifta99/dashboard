...
public class KelahiranDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context context;
    private final List<tampil> results;

    public KelahiranDetailAdapter(Context context, List<tampil> results) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        KelahiranDetailAdapter.MyHolder holder = new KelahiranDetailAdapter.MyHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        KelahiranDetailAdapter.MyHolder myHolder = (KelahiranDetailAdapter.MyHolder) holder;
