...
import mifta.code.dispendukproject1.activity.PerkawinanDesaActivity;
...
public class AktaPerkawinanAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        AktaPerkawinanAdapter.MyHolder holder = new AktaPerkawinanAdapter.MyHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        AktaPerkawinanAdapter.MyHolder myHolder = (AktaPerkawinanAdapter.MyHolder) holder;
