...
public class PerceraianDesaAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PerceraianDesaAdapter(Context context, List<tampil> results) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        PerceraianDesaAdapter.MyHolder holder = new PerceraianDesaAdapter.MyHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        PerceraianDesaAdapter.MyHolder myHolder = (PerceraianDesaAdapter.MyHolder) holder;
        ...
        if (Integer.valueOf(result.getJUMLAH()) != 0){
            myHolder.crd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(view.getContext(), PerceraianDetailActivity.class);
