...
public class PerceraianDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context context;
    private final List<tampil> results;

    public PerceraianDetailAdapter(Context context, List<tampil> results) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        PerceraianDetailAdapter.MyHolder holder = new PerceraianDetailAdapter.MyHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        PerceraianDetailAdapter.MyHolder myHolder = (PerceraianDetailAdapter.MyHolder) holder;
        ...
        myHolder.tgl.setText(result.getTGL_CERAI());
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout ly_doc, ly_nik, ly_kk, ly_nama, ly_tgl, ly_alamat, ly_niks, ly_niki, ly_nms, ly_nmi, ly_cerai;
        ...
        public MyHolder(View itemView) {
            ...
            tgl = itemView.findViewById(R.id.tvx_tgl_cerai);
            ...
            ly_cerai.setVisibility(View.VISIBLE);
