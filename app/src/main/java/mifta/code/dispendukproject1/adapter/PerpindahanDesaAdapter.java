...
import mifta.code.dispendukproject1.activity.PerpindahanDetailActivity;
import mifta.code.dispendukproject1.api.tampil;

public class PerpindahanDesaAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context context;
    private final List<tampil> results;

    public PerpindahanDesaAdapter(Context context, List<tampil> results) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        PerpindahanDesaAdapter.MyHolder holder = new PerpindahanDesaAdapter.MyHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        PerpindahanDesaAdapter.MyHolder myHolder = (PerpindahanDesaAdapter.MyHolder) holder;
        ...
        if (Integer.valueOf(result.getJUMLAH()) != 0) {
            myHolder.crd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(view.getContext(), PerpindahanDetailActivity.class);
