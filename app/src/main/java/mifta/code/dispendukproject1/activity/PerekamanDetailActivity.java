...
import mifta.code.dispendukproject1.adapter.PencetakanDetailAdapter;
import mifta.code.dispendukproject1.adapter.PerekamanDetailAdapter;
...
public class PerekamanDetailActivity extends AppCompatActivity {
    TextView tanggal, bulan, tahun, hari, total_kab, nama, judul;
    RecyclerView recyclerView;
    ProgressBar progressBar;
    private List<tampil> results = new ArrayList<>();
    private PerekamanDetailAdapter perekamanDetailAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        judul.setText("PEREKAMAN KTP-EL");
    ...
    private void detail() {
        ...
        Call<respon> aksi = api.perekaman_detail(jwt_, no_kec, no_kel);
        ...
        aksi.enqueue(new Callback<respon>() {
            ...
            public void onResponse(Call<respon> call, Response<respon> response) {
                ...
                if (response.code() == 200) {
                    ...
                    perekamanDetailAdapter = new PerekamanDetailAdapter(PerekamanDetailActivity.this, results);
                    recyclerView.getRecycledViewPool().clear();
                    perekamanDetailAdapter.notifyDataSetChanged();
                    recyclerView.setAdapter(perekamanDetailAdapter);
                } else if(response.code() == 204){
                    Toast.makeText(PerekamanDetailActivity.this, "Data Tidak Ada", Toast.LENGTH_LONG).show();
                }else {
                    Toast.makeText(PerekamanDetailActivity.this, "Token tidak valid atau Token expired", Toast.LENGTH_SHORT).show();
                    logout();
                }
            }
    ...
    private void logout() {
        ...
        akses.clear();
        akses.commit();
        startActivity(new Intent(PerekamanDetailActivity.this, LoginActivity.class));
        finish();
    }
}