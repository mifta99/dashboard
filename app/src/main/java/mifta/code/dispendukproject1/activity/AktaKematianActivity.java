...
public class AktaKematianActivity extends AppCompatActivity {
    ...
    private void tampil_kec() {
        ...
        Call<respon> aksi = api.count_kematian_kec(jwt_);
        ...
        aksi.enqueue(new Callback<respon>() {
            ...
            public void onResponse(Call<respon> call, Response<respon> response) {
                ...
                if (response.code() != 200) {
                    Toast.makeText(AktaKematianActivity.this, "Token tidak valid atau Token expired", Toast.LENGTH_SHORT).show();
                    logout();
                } else {
                    showLoading(false);
