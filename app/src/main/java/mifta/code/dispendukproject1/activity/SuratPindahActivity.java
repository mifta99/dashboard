...
public class SuratPindahActivity extends AppCompatActivity {
    ...
    private SuratPindahAdapter suratPindahAdapter;
    ...
    private void tampil_kec() {
        ...
        Call<respon> aksi = api.count_perpindahan_kec(jwt_);
        ...
        aksi.enqueue(new Callback<respon>() {
            ...
            public void onResponse(Call<respon> call, Response<respon> response) {
                ...
                if (response.code() != 200) {
                    Toast.makeText(SuratPindahActivity.this, "Token tidak valid atau Token expired", Toast.LENGTH_SHORT).show();
                    logout();
                } else {
                    showLoading(false);
    ...
    private void tampil_kab() {
        ...
        Call<respon> aksi = api.count_perpindahan_kab(jwt_);
    ...
    private void logout() {
        ...
        akses.clear();
        akses.commit();
        startActivity(new Intent(SuratPindahActivity.this, LoginActivity.class));
        finish();
    }
}