...
import mifta.code.dispendukproject1.adapter.KematianDetailAdapter;
...
public class KematianDetailActivity extends AppCompatActivity {
    ...
    private KematianDetailAdapter kematianDetailAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        judul.setText("PERMOHONAN AKTA KEMATIAN");
    ...
    private void detail() {
        ...
        Call<respon> aksi = api.kematian_detail(jwt_, no_kec, no_kel);
        ...
        aksi.enqueue(new Callback<respon>() {
            ...
            public void onResponse(Call<respon> call, Response<respon> response) {
                ...
                if (response.code() == 200) {
                    ...
                    kematianDetailAdapter = new KematianDetailAdapter(KematianDetailActivity.this, results);
                    recyclerView.getRecycledViewPool().clear();
                    kematianDetailAdapter.notifyDataSetChanged();
                    recyclerView.setAdapter(kematianDetailAdapter);
                } else if (response.code() == 204) {
                    Toast.makeText(KematianDetailActivity.this, "Data Tidak Ada", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(KematianDetailActivity.this, "Token tidak valid atau Token expired", Toast.LENGTH_SHORT).show();
                    logout();
                }
            }
    ...
    private void logout() {
        ...
        akses.clear();
        akses.commit();
        startActivity(new Intent(KematianDetailActivity.this, LoginActivity.class));
        finish();
    }
}