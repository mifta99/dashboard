...
import mifta.code.dispendukproject1.adapter.AktaPerceraianAdapter;
...
public class AktaPerceraianActivity extends AppCompatActivity {
    ...
    private AktaPerceraianAdapter aktaPerceraianAdapter;
    ...
    private void tampil_kec() {
        ...
        Call<respon> aksi = api.count_perceraian_kec(jwt_);
        ...
        aksi.enqueue(new Callback<respon>() {
            ...
            public void onResponse(Call<respon> call, Response<respon> response) {
                ...
                if (response.code() != 200) {
                    Toast.makeText(AktaPerceraianActivity.this, "Token tidak valid atau Token expired", Toast.LENGTH_SHORT).show();
                    logout();
                } else {
                    showLoading(false);
    ...
    private void logout() {
        ...
        akses.clear();
        akses.commit();
        startActivity(new Intent(AktaPerceraianActivity.this, LoginActivity.class));
        finish();
    }
}