...
import mifta.code.dispendukproject1.adapter.PerpindahanDetailAdapter;
...
public class PerpindahanDetailActivity extends AppCompatActivity {
    TextView tanggal, bulan, tahun, hari, total_kab, nama, judul;
    RecyclerView recyclerView;
    ProgressBar progressBar;
    private List<tampil> results = new ArrayList<>();
    private PerpindahanDetailAdapter perpindahanDetailAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        judul.setText("PERMOHONAN SURAT PINDAH");
    ...
    private void detail() {
        ...
        Call<respon> aksi = api.perpindahan_detail(jwt_, no_kec, no_kel);
        ...
        aksi.enqueue(new Callback<respon>() {
            ...
            public void onResponse(Call<respon> call, Response<respon> response) {
                ...
                if (response.code() == 200) {
                    ...
                    perpindahanDetailAdapter = new PerpindahanDetailAdapter(PerpindahanDetailActivity.this, results);
                    recyclerView.getRecycledViewPool().clear();
                    perpindahanDetailAdapter.notifyDataSetChanged();
                    recyclerView.setAdapter(perpindahanDetailAdapter);
                } else if (response.code() == 204) {
                    Toast.makeText(PerpindahanDetailActivity.this, "Data Tidak Ada", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(PerpindahanDetailActivity.this, "Token tidak valid atau Token expired", Toast.LENGTH_SHORT).show();
                    logout();
                }
            }
    ...
    private void logout() {
        ...
        akses.clear();
        akses.commit();
        startActivity(new Intent(PerpindahanDetailActivity.this, LoginActivity.class));
        finish();
    }
}