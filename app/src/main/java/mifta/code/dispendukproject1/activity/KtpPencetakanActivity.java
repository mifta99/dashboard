...
import mifta.code.dispendukproject1.adapter.KtpPencetakanAdapter;
...
public class KtpPencetakanActivity extends AppCompatActivity {
    TextView tanggal, bulan, tahun, hari, total_kab, judul, nama;
    RecyclerView recyclerView;
    ProgressBar progressBar;
    private List<tampil> results = new ArrayList<>();
    private KtpPencetakanAdapter ktpPencetakanAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        judul.setText("Total Pencetakan");
        nama.setText("KTP Elektronik");
    ...
    private void tampil_kec() {
        ...
        Call<respon> aksi = api.count_ktp_pencetakan_kec(jwt_);
        ...
        aksi.enqueue(new Callback<respon>() {
            ...
            public void onResponse(Call<respon> call, Response<respon> response) {
                ...
                if (response.code() != 200) {
                    Toast.makeText(KtpPencetakanActivity.this, "Token tidak valid atau Token expired", Toast.LENGTH_SHORT).show();
                    logout();
                } else {
                    showLoading(false);
    ...
    private void tampil_kab() {
        ...
        Call<respon> aksi = api.count_ktp_pencetakan_kab(jwt_);
    ...
    private void logout() {
        ...
        akses.clear();
        akses.commit();
        startActivity(new Intent(KtpPencetakanActivity.this, LoginActivity.class));
        finish();
    }
}