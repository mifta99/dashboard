...
import mifta.code.dispendukproject1.adapter.AktaPerkawinanAdapter;
...
public class AktaPerkawinanActivity extends AppCompatActivity {
    ...
    private AktaPerkawinanAdapter aktaPerkawinanAdapter;
    ...
    private void tampil_kec() {
        ...
        Call<respon> aksi = api.count_perkawinan_kec(jwt_);
        ...
        aksi.enqueue(new Callback<respon>() {
            ...
            public void onResponse(Call<respon> call, Response<respon> response) {
                ...
                if (response.code() != 200) {
                    Toast.makeText(AktaPerkawinanActivity.this, "Token tidak valid atau Token expired", Toast.LENGTH_SHORT).show();
                    logout();
                } else {
                    showLoading(false);
    ...
    private void logout() {
        ...
        akses.clear();
        akses.commit();
        startActivity(new Intent(AktaPerkawinanActivity.this, LoginActivity.class));
        finish();
    }
}