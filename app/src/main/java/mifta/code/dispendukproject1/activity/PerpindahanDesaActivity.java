...
import mifta.code.dispendukproject1.adapter.PerpindahanDesaAdapter;
...
public class PerpindahanDesaActivity extends AppCompatActivity {
    TextView tanggal, bulan, tahun, hari, total_kab, nama, judul;
    RecyclerView recyclerView;
    ProgressBar progressBar;
    private List<tampil> results = new ArrayList<>();
    private PerpindahanDesaAdapter perpindahanDesaAdapter;
    private int no_kec;
    ...
    private void desa() {
        ...
        Call<respon> aksi = api.perpindahan_desa(jwt_, no_kec);;
        ...
        aksi.enqueue(new Callback<respon>() {
            ...
            public void onResponse(Call<respon> call, Response<respon> response) {
                ...
                if (response.code() != 200) {
                    Toast.makeText(PerpindahanDesaActivity.this, "Token tidak valid atau Token expired", Toast.LENGTH_SHORT).show();
                    logout();
                } else {
                    showLoading(false);
                    results = response.body().getResult();
                    perpindahanDesaAdapter = new PerpindahanDesaAdapter(PerpindahanDesaActivity.this, results);
                    recyclerView.getRecycledViewPool().clear();
                    perpindahanDesaAdapter.notifyDataSetChanged();
                    recyclerView.setAdapter(perpindahanDesaAdapter);
                }
            }
    ...
    private void logout() {
        ...
        akses.clear();
        akses.commit();
        startActivity(new Intent(PerpindahanDesaActivity.this, LoginActivity.class));
        finish();
    }
}