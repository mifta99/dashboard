...
public class PencetakanDetailActivity extends AppCompatActivity {
    TextView tanggal, bulan, tahun, hari, total_kab, nama, judul;
    RecyclerView recyclerView;
    ProgressBar progressBar;
    private List<tampil> results = new ArrayList<>();
    private PencetakanDetailAdapter pencetakanDetailAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        judul.setText("PENCETAKAN KTP-EL");
    ...
    private void detail() {
        ...
        Call<respon> aksi = api.pencetakan_detail(jwt_, no_kec, no_kel);
        ...
        aksi.enqueue(new Callback<respon>() {
            ...
            public void onResponse(Call<respon> call, Response<respon> response) {
                ...
                if (response.code() == 200) {
                    ...
                    pencetakanDetailAdapter = new PencetakanDetailAdapter(PencetakanDetailActivity.this, results);
                    recyclerView.getRecycledViewPool().clear();
                    pencetakanDetailAdapter.notifyDataSetChanged();
                    recyclerView.setAdapter(pencetakanDetailAdapter);
                } else if (response.code() == 204) {
                    Toast.makeText(PencetakanDetailActivity.this, "Data Tidak Ada", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(PencetakanDetailActivity.this, "Token tidak valid atau Token expired", Toast.LENGTH_SHORT).show();
                    logout();
                }
            }
    ...
    private void logout() {
        ...
        akses.clear();
        akses.commit();
        startActivity(new Intent(PencetakanDetailActivity.this, LoginActivity.class));
        finish();
    }
}