...
public class KelahiranDesaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kelahiran_desa);
        ...
        aksi.enqueue(new Callback<respon>() {
            ...
            public void onResponse(Call<respon> call, Response<respon> response) {
                ...
                if (response.code() != 200) {
                    Toast.makeText(KelahiranDesaActivity.this, "Token tidak valid atau Token expired", Toast.LENGTH_SHORT).show();
                    logout();
                } else {
                    showLoading(false);
    ...
    private void logout() {
        ...
        akses.clear();
        akses.commit();
        startActivity(new Intent(KelahiranDesaActivity.this, LoginActivity.class));
        finish();
    }
}